...
<body>
<div class="container">
<h3 class="text-black">Customers </h3><button class="btn bg-primary" data-toggle="modal" data-target="#addModal">Add Customers</button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="catagory">Edit Customer</h4>
            </div>
            <br>
