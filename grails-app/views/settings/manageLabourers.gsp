...
<body>
<div class="container">
    <h3 class="text-black">Labourers</h3>
    <button class="btn bg-primary" data-toggle="modal" data-target="#addModal">Add Labourers</button>
    <hr>
    ...
    <table id="tableList" class="table table-striped table-hover table-responsive">
        ...
        <tr>
            ...
            <td>
                ...
                <g:link controller="settings" action="deleteLabourer" onclick="return confirm('Do you want to delete this Job Title?')"><i class="glyphicon glyphicon-remove"></i></g:link>
            </td>
        </tr>
        <tr>
            <td>Laxmi Lekhak</td>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="catagory">Edit Labourer</h4>
                </div>
                <br>
                <g:form class="form-horizontal" controller="settings" action="addJobTitler">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-lg-3 control-label">Labour Type</label>
                        <div class="col-lg-8">
                            <select class="form-control" name="jobTitle" id="jobTitle">
                                <option value="1">Pathai</option>
                                <option>Bharai</option>
                                <option>Nikasi</option>
                                <option>Rabish</option>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">Add Labourer</h4>
                </div>
                <br>
                <g:form class="form-horizontal" controller="settings" action="addLabourer">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control" name="jobTitle">
                                <option value="1">Pathai</option>
                                <option value="1">Bharai</option>
                                <option value="1">Nikasi</option>
                                <option value="1">Rabish</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
